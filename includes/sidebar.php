        ...
        <ul class="navbar-nav bg-gradient-primary sidebar  accordion" id="accordionSidebar" style="background: #7258db; ">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php" style="color:#fff">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-virus" style="color: red"></i>
                </div>
                <div class="sidebar-brand-text mx-3">COVID-19 TMS</div>
            </a>
